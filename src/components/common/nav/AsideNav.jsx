                ...
                <nav className="flex flex-col gap-2">
                    {items.map((it) => {
                        ...
                        const activeCls = `${
                                                   ...
                                                   // 활성: 그라디언트 + 텍스트/보더까지 한 번에 묶어서 적용
                            ui.activeGradientClass || "bg-gradient-to-r from-pink-400 to-purple-400"
                                                } text-white border-transparent shadow-sm hover:brightness-105`;
